...
namespace InfrastructureModule.Context
{
    public class AppDbContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.ApplyConfiguration(new CustomerTransactionConfiguration());
            builder.ApplyConfiguration(new ItemConfiguration());
            builder.ApplyConfiguration(new PurchaseConfiguration());
            builder.ApplyConfiguration(new PurchaseDetailConfiguration());
        ...
        {
            var EnableAudit = _configuration["RecordAuditLog"];
            if (EnableAudit == "True")
            {
